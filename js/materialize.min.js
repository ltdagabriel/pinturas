...
!function (t) {
    ...
    var lt = ["", "webkit", "moz", "MS", "ms", "o"], ct = e.createElement("div"), ut = "function", dt = Math.round,
        ...
        xt = 1, Ct = 2, Tt = 4, St = 8, Pt = 1, At = 2, Ot = 4, _t = 8, Et = 16, Mt = At | Ot, It = _t | Et,
        Dt = Mt | It, Vt = ["x", "y"], qt = ["clientX", "clientY"];
    T.prototype = {
        handler: function () {
        }, init: function () {
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (t) {
        ...
        init: function (e) {
            ...
            return this.each(function (i) {
                var o, a, r, s, l, c = n + i, u = t(this), d = t(window).width(), p = u.find("li.tab a"), h = u.width(),
                    f = t(), v = Math.max(h, u[0].scrollWidth) / p.length, m = prev_index = 0, g = !1,
                    y = function (t) {
    ...
    function n(n, r) {
        ...
        var u = a(C), d = u.find(".clockpicker-plate"), v = u.find(".picker__holder"), m = u.find(".clockpicker-hours"),
            T = u.find(".clockpicker-minutes"), S = u.find(".clockpicker-am-pm-block"),
            P = "INPUT" === n.prop("tagName"), A = P ? n : n.find("input"), O = a("label[for=" + A.attr("id") + "]"),
            _ = this;
            ...
            return this.each(function () {
                ...
                var l = function () {
                    ...
                    var c = i.outerWidth(), u = i.outerHeight(),
                        ...
                        A = k ? x : x / 2 + c, O = C / 2, _ = b ? C / 2 : 0, E = g && !k ? x / 2 - c : 0, M = c,
                        I = w ? "bottom" : "top", D = 2 * c, V = D, q = C / 2 - V / 2, z = x / 2 - D / 2, H = {};
